...
class BaseInfoSerializer(serializers.Serializer):
    ...
    average_rating = serializers.DecimalField(read_only=True, max_digits=2, decimal_places=1, coerce_to_string=False, help_text="Average rating across all reviews.")
